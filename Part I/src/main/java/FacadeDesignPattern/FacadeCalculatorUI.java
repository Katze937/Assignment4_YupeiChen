 ...
 * @author isabe
 */
public class FacadeCalculatorUI extends javax.swing.JFrame {


    private FacadeCalculator facadeCalculator = new FacadeCalculator();
    /**
     * Creates new form CalculatorUI
     */
    public FacadeCalculatorUI() {
        initComponents();
    }
    ...
    private void DivideButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DivideButtonActionPerformed
        ...
        try {
            ...
            switch (operation) {
                case Add:
                    result = facadeCalculator.PerformAdd(a, b);
                    break;
                case Subtract:
                    result = facadeCalculator.PerformSubtract(a, b);
                    break;
                case Multiply:
                    result = facadeCalculator.PerformMultiply(a, b);
                    break;
                case Divide:
                    result = facadeCalculator.PerformDivide(a, b);
                    break;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacadeCalculatorUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacadeCalculatorUI().setVisible(true);
            }
        });
    }
